...
public class SimpleCommand implements CommandExecutor
{
        ...
        for (Method method : handler.getClass().getMethods())
        {
            ...
            if (params.length == 2 && CommandSender.class.isAssignableFrom(params[0]) && String[].class.equals(params[1]))
            {
                ...
                if (isCommandHandler(method))
                {
                    ...
                    {
                        plugin.getCommand(annotation.name()).setExecutor(new SimpleCommand());
                ...
                if (isSubCommandHandler(method))
                {
                    ...
                    {
                        plugin.getCommand(annotation.parent()).setExecutor(new SimpleCommand());
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
         ...
         */
            ...
            sender.sendMessage(ChatColor.AQUA + "[TheParkMC] " + ChatColor.DARK_RED + "Sorry, BajanAmerican did not put that in as a command! " + ChatColor.GOLD + "Type \"help\" for a list of commands!");
